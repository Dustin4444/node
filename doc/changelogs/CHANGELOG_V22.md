...
## 2026-02-24, Version 22.22.1 'Jod' (LTS), @ruyadorno prepared by @aduh95
...
* \[[`580ce8c099`](https://github.com/nodejs/node/commit/580ce8c099)] - **cli**: mark `--heapsnapshot-near-heap-limit` as stable (Joyee Cheung) [#60956](https://github.com/nodejs/node/pull/60956)
...
* \[[`9dc1ec740d`](https://github.com/nodejs/node/commit/9dc1ec740d)] - **doc**: add @avivkeller to collaborators (Aviv Keller) [#61115](https://github.com/nodejs/node/pull/61115)
* \[[`9b23f7cd7b`](https://github.com/nodejs/node/commit/9b23f7cd7b)] - **doc**: add gurgunday to collaborators (Gürgün Dayıoğlu) [#61094](https://github.com/nodejs/node/pull/61094)
* \[[`e8f9ea6bda`](https://github.com/nodejs/node/commit/e8f9ea6bda)] - **meta**: add Renegade334 to collaborators (Renegade334) [#60714](https://github.com/nodejs/node/pull/60714)
...
* \[[`9a9b92911b`](https://github.com/nodejs/node/commit/9a9b92911b)] - **assert,util**: fix deep comparison for sets and maps with mixed types (Ruben Bridgewater) [#61388](https://github.com/nodejs/node/pull/61388)
* \[[`35783738bd`](https://github.com/nodejs/node/commit/35783738bd)] - **benchmark**: add SQLite benchmarks (Guilherme Araújo) [#61401](https://github.com/nodejs/node/pull/61401)
...
* \[[`2e39a53f93`](https://github.com/nodejs/node/commit/2e39a53f93)] - **build**: skip sscache action on non-main branches (Joyee Cheung) [#61790](https://github.com/nodejs/node/pull/61790)
* \[[`25a0425daa`](https://github.com/nodejs/node/commit/25a0425daa)] - **build**: update android-patches/trap-handler.h.patch (Mo Luo) [#60369](https://github.com/nodejs/node/pull/60369)
* \[[`175578643f`](https://github.com/nodejs/node/commit/175578643f)] - **build**: update devcontainer.json to use paired nix env (Joyee Cheung) [#61414](https://github.com/nodejs/node/pull/61414)
* \[[`bd4da1df18`](https://github.com/nodejs/node/commit/bd4da1df18)] - **build**: fix misplaced comma in ldflags (hqzing) [#61294](https://github.com/nodejs/node/pull/61294)
* \[[`d54310771f`](https://github.com/nodejs/node/commit/d54310771f)] - **build**: fix crate vendor file checksums on windows (Chengzhong Wu) [#61329](https://github.com/nodejs/node/pull/61329)
...
* \[[`d60a6cebd5`](https://github.com/nodejs/node/commit/d60a6cebd5)] - **build**: update test-wpt-report to use NODE instead of OUT\_NODE (Filip Skokan) [#61024](https://github.com/nodejs/node/pull/61024)
...
* \[[`7b19e101a2`](https://github.com/nodejs/node/commit/7b19e101a2)] - **build**: run embedtest with node\_g when BUILDTYPE=Debug (Chengzhong Wu) [#60850](https://github.com/nodejs/node/pull/60850)
...
* \[[`73ef70145d`](https://github.com/nodejs/node/commit/73ef70145d)] - **build**: remove V8\_COMPRESS\_POINTERS\_IN\_ISOLATE\_CAGE defs (Joyee Cheung) [#60296](https://github.com/nodejs/node/pull/60296)
* \[[`7b93a65f27`](https://github.com/nodejs/node/commit/7b93a65f27)] - **build**: test on Python 3.14 (Christian Clauss) [#59983](https://github.com/nodejs/node/pull/59983)
...
* \[[`3a5037f418`](https://github.com/nodejs/node/commit/3a5037f418)] - **build,tools**: fix addon build deadlock on errors (Vladimir Morozov) [#61321](https://github.com/nodejs/node/pull/61321)
* \[[`c224c865ad`](https://github.com/nodejs/node/commit/c224c865ad)] - **build,win**: update WinGet configurations to Python 3.14 (Mike McCready) [#61431](https://github.com/nodejs/node/pull/61431)
* \[[`72c1e036fa`](https://github.com/nodejs/node/commit/72c1e036fa)] - **child\_process**: treat ipc length header as unsigned uint32 (Ryuhei Shima) [#61344](https://github.com/nodejs/node/pull/61344)
...
* \[[`e28d20f698`](https://github.com/nodejs/node/commit/e28d20f698)] - **cluster**: fix port reuse between cluster (Ryuhei Shima) [#60141](https://github.com/nodejs/node/pull/60141)
...
* \[[`73e9c4ce4e`](https://github.com/nodejs/node/commit/73e9c4ce4e)] - **deps**: V8: backport 6a0a25abaed3 (Vivian Wang) [#61688](https://github.com/nodejs/node/pull/61688)
* \[[`681adc2ee9`](https://github.com/nodejs/node/commit/681adc2ee9)] - **deps**: update googletest to 85087857ad10bd407cd6ed2f52f7ea9752db621f (Node.js GitHub Bot) [#61417](https://github.com/nodejs/node/pull/61417)
* \[[`695fcb298f`](https://github.com/nodejs/node/commit/695fcb298f)] - **deps**: update sqlite to 3.51.2 (Node.js GitHub Bot) [#61339](https://github.com/nodejs/node/pull/61339)
* \[[`e1521ca72b`](https://github.com/nodejs/node/commit/e1521ca72b)] - **deps**: update icu to 78.2 (Node.js GitHub Bot) [#60523](https://github.com/nodejs/node/pull/60523)
* \[[`51ea57a418`](https://github.com/nodejs/node/commit/51ea57a418)] - **deps**: update zlib to 1.3.1-e00f703 (Node.js GitHub Bot) [#61135](https://github.com/nodejs/node/pull/61135)
...
* \[[`b671f60506`](https://github.com/nodejs/node/commit/b671f60506)] - **doc**: supported toolchain with Visual Studio 2022 only (Mike McCready) [#61451](https://github.com/nodejs/node/pull/61451)
* \[[`021e65e4be`](https://github.com/nodejs/node/commit/021e65e4be)] - **doc**: move Security-Team from TSC to SECURITY (Rafael Gonzaga) [#61495](https://github.com/nodejs/node/pull/61495)
* \[[`ed34243d48`](https://github.com/nodejs/node/commit/ed34243d48)] - **doc**: added `requestOCSP` option to `tls.connect` (ikeyan) [#61064](https://github.com/nodejs/node/pull/61064)
* \[[`db56f9d38d`](https://github.com/nodejs/node/commit/db56f9d38d)] - **doc**: restore @ChALkeR to collaborators (Сковорода Никита Андреевич) [#61553](https://github.com/nodejs/node/pull/61553)
* \[[`558ba0de36`](https://github.com/nodejs/node/commit/558ba0de36)] - **doc**: update IBM/Red Hat volunteers with dedicated project time (Beth Griggs) [#61588](https://github.com/nodejs/node/pull/61588)
* \[[`fddb2bc5f3`](https://github.com/nodejs/node/commit/fddb2bc5f3)] - **doc**: mention constructor comparison in assert.deepStrictEqual (Hamza Kargin) [#60253](https://github.com/nodejs/node/pull/60253)
* \[[`c484dd2840`](https://github.com/nodejs/node/commit/c484dd2840)] - **doc**: add CVE delay mention (Rafael Gonzaga) [#61465](https://github.com/nodejs/node/pull/61465)
* \[[`c1c53af934`](https://github.com/nodejs/node/commit/c1c53af934)] - **doc**: include OpenJSF handle for security stewards (Rafael Gonzaga) [#61454](https://github.com/nodejs/node/pull/61454)
* \[[`2673dd74cb`](https://github.com/nodejs/node/commit/2673dd74cb)] - **doc**: clarify process.argv\[1] behavior for -e/--eval (Jeevankumar S) [#61366](https://github.com/nodejs/node/pull/61366)
* \[[`ae499029bc`](https://github.com/nodejs/node/commit/ae499029bc)] - **doc**: remove Windows Dev Home instructions from BUILDING (Mike McCready) [#61434](https://github.com/nodejs/node/pull/61434)
* \[[`90c6784979`](https://github.com/nodejs/node/commit/90c6784979)] - **doc**: clarify TypedArray properties on Buffer (Roman Reiss) [#61355](https://github.com/nodejs/node/pull/61355)
* \[[`c69b719b4c`](https://github.com/nodejs/node/commit/c69b719b4c)] - **doc**: note resume build should not be done on node-test-commit (Stewart X Addison) [#61373](https://github.com/nodejs/node/pull/61373)
* \[[`75b87bae2f`](https://github.com/nodejs/node/commit/75b87bae2f)] - **doc**: refine WebAssembly error documentation (sangwook) [#61382](https://github.com/nodejs/node/pull/61382)
* \[[`5ce933995f`](https://github.com/nodejs/node/commit/5ce933995f)] - **doc**: add deprecation history for url.parse (Eng Zer Jun) [#61389](https://github.com/nodejs/node/pull/61389)
* \[[`d4c1a7e5ff`](https://github.com/nodejs/node/commit/d4c1a7e5ff)] - **doc**: add marco and rafael in last sec release (Marco Ippolito) [#61383](https://github.com/nodejs/node/pull/61383)
* \[[`f05fa42f5a`](https://github.com/nodejs/node/commit/f05fa42f5a)] - **doc**: packages: example of private import switch to internal (coderaiser) [#61343](https://github.com/nodejs/node/pull/61343)
* \[[`8ff217ab1d`](https://github.com/nodejs/node/commit/8ff217ab1d)] - **doc**: add esm and cjs examples to node:v8 (Alfredo González) [#61328](https://github.com/nodejs/node/pull/61328)
* \[[`71a5e90e80`](https://github.com/nodejs/node/commit/71a5e90e80)] - **doc**: added 'secure' event to tls.TLSSocket (ikeyan) [#61066](https://github.com/nodejs/node/pull/61066)
* \[[`09452d42dc`](https://github.com/nodejs/node/commit/09452d42dc)] - **doc**: restore @watilde to collaborators (Daijiro Wachi) [#61350](https://github.com/nodejs/node/pull/61350)
* \[[`f24d3e4a42`](https://github.com/nodejs/node/commit/f24d3e4a42)] - **doc**: run license-builder (github-actions\[bot]) [#61348](https://github.com/nodejs/node/pull/61348)
* \[[`284bb5b4e2`](https://github.com/nodejs/node/commit/284bb5b4e2)] - **doc**: document ALPNCallback option for TLSSocket constructor (ikeyan) [#61331](https://github.com/nodejs/node/pull/61331)
* \[[`fe7c3e7192`](https://github.com/nodejs/node/commit/fe7c3e7192)] - **doc**: update MDN links (Livia Medeiros) [#61062](https://github.com/nodejs/node/pull/61062)
* \[[`1bc53b29a8`](https://github.com/nodejs/node/commit/1bc53b29a8)] - **doc**: add documentation for process.traceProcessWarnings (Alireza Ebrahimkhani) [#53641](https://github.com/nodejs/node/pull/53641)
* \[[`b2483796e7`](https://github.com/nodejs/node/commit/b2483796e7)] - **doc**: add sqlite session disposal method (René) [#61273](https://github.com/nodejs/node/pull/61273)
...
* \[[`9eeeb3a59a`](https://github.com/nodejs/node/commit/9eeeb3a59a)] - **events**: remove redundant todo (Gürgün Dayıoğlu) [#60595](https://github.com/nodejs/node/pull/60595)
...
* \[[`ea3704eec6`](https://github.com/nodejs/node/commit/ea3704eec6)] - **fs**: remove duplicate getValidatedPath calls (Mert Can Altin) [#61359](https://github.com/nodejs/node/pull/61359)
* \[[`515ee53e85`](https://github.com/nodejs/node/commit/515ee53e85)] - **fs**: fix errorOnExist behavior for directory copy in fs.cp (Nicholas Paun) [#60946](https://github.com/nodejs/node/pull/60946)
* \[[`e600b83ac7`](https://github.com/nodejs/node/commit/e600b83ac7)] - **fs**: fix ENOTDIR in globSync when file is treated as dir (sangwook) [#61259](https://github.com/nodejs/node/pull/61259)
* \[[`215d2aa792`](https://github.com/nodejs/node/commit/215d2aa792)] - **fs**: remove duplicate fd validation in sync functions (Mert Can Altin) [#61361](https://github.com/nodejs/node/pull/61361)
...
* \[[`c9c9ef236b`](https://github.com/nodejs/node/commit/c9c9ef236b)] - **gyp**: aix: change gcc version detection so CXX="ccache g++" works (Stewart X Addison) [#61464](https://github.com/nodejs/node/pull/61464)
* \[[`a9fe366a24`](https://github.com/nodejs/node/commit/a9fe366a24)] - **http**: fix rawHeaders exceeding maxHeadersCount limit (Max Harari) [#61285](https://github.com/nodejs/node/pull/61285)
...
* \[[`f074c126a8`](https://github.com/nodejs/node/commit/f074c126a8)] - **http,https**: fix double ERR\_PROXY\_TUNNEL emission (Shima Ryuhei) [#60699](https://github.com/nodejs/node/pull/60699)
...
* \[[`0bf84b83c7`](https://github.com/nodejs/node/commit/0bf84b83c7)] - **lib**: fix typo in `util.js` comment (Taejin Kim) [#61365](https://github.com/nodejs/node/pull/61365)
* \[[`725f2343bd`](https://github.com/nodejs/node/commit/725f2343bd)] - **lib**: fix TypeScript support check in jitless mode (sangwook) [#61382](https://github.com/nodejs/node/pull/61382)
...
* \[[`c820c54b63`](https://github.com/nodejs/node/commit/c820c54b63)] - **meta**: do not fast-track npm updates (Antoine du Hamel) [#61475](https://github.com/nodejs/node/pull/61475)
* \[[`12a40302b7`](https://github.com/nodejs/node/commit/12a40302b7)] - **meta**: fix typos in issue template config (Daijiro Wachi) [#61399](https://github.com/nodejs/node/pull/61399)
* \[[`c4ad606ea2`](https://github.com/nodejs/node/commit/c4ad606ea2)] - **meta**: label v8 module PRs (René) [#61325](https://github.com/nodejs/node/pull/61325)
...
* \[[`2441f68a4e`](https://github.com/nodejs/node/commit/2441f68a4e)] - **node-api**: use Node-API in comments (Vladimir Morozov) [#61320](https://github.com/nodejs/node/pull/61320)
...
* \[[`e992057ab7`](https://github.com/nodejs/node/commit/e992057ab7)] - **perf\_hooks**: fix stack overflow error (Antoine du Hamel) [#60084](https://github.com/nodejs/node/pull/60084)
...
* \[[`d27668ebad`](https://github.com/nodejs/node/commit/d27668ebad)] - **src**: replace `ranges::sort` for libc++13 compatibility on armhf (Rebroad) [#61789](https://github.com/nodejs/node/pull/61789)
* \[[`3439754581`](https://github.com/nodejs/node/commit/3439754581)] - **src**: add missing override specifier to Clean() (Tobias Nießen) [#61429](https://github.com/nodejs/node/pull/61429)
* \[[`15be84acd3`](https://github.com/nodejs/node/commit/15be84acd3)] - **src**: cache context lookup in vectored io loops (Mert Can Altin) [#61387](https://github.com/nodejs/node/pull/61387)
* \[[`1fb37b1a2d`](https://github.com/nodejs/node/commit/1fb37b1a2d)] - **src**: use C++ nullptr in webstorage (Tobias Nießen) [#61407](https://github.com/nodejs/node/pull/61407)
* \[[`5a1d8ae8df`](https://github.com/nodejs/node/commit/5a1d8ae8df)] - **src**: fix pointer alignment (jhofstee) [#61336](https://github.com/nodejs/node/pull/61336)
* \[[`a96256524c`](https://github.com/nodejs/node/commit/a96256524c)] - **src**: dump snapshot source with node:generate\_default\_snapshot\_source (Joyee Cheung) [#61101](https://github.com/nodejs/node/pull/61101)
* \[[`ec051b9efd`](https://github.com/nodejs/node/commit/ec051b9efd)] - **src**: add HandleScope to edge loop in heap\_utils (Mert Can Altin) [#60885](https://github.com/nodejs/node/pull/60885)
...
* \[[`93393371f9`](https://github.com/nodejs/node/commit/93393371f9)] - **src**: use static\_cast instead of C-style cast (Michaël Zasso) [#60868](https://github.com/nodejs/node/pull/60868)
...
* \[[`e0517752e7`](https://github.com/nodejs/node/commit/e0517752e7)] - **src**: remove unconditional NAPI\_EXPERIMENTAL in node.h (Chengzhong Wu) [#60345](https://github.com/nodejs/node/pull/60345)
...
* \[[`ece4acc18f`](https://github.com/nodejs/node/commit/ece4acc18f)] - **src**: add COUNT\_GENERIC\_USAGE utility for tests (Joyee Cheung) [#60434](https://github.com/nodejs/node/pull/60434)
* \[[`31c8e9d9ff`](https://github.com/nodejs/node/commit/31c8e9d9ff)] - **src**: use cached primordials\_string (Sohyeon Kim) [#60255](https://github.com/nodejs/node/pull/60255)
...
* \[[`e55a2b895a`](https://github.com/nodejs/node/commit/e55a2b895a)] - **src,permission**: add debug log on is\_tree\_granted (Rafael Gonzaga) [#60668](https://github.com/nodejs/node/pull/60668)
...
* \[[`a34f5950b3`](https://github.com/nodejs/node/commit/a34f5950b3)] - **test**: mark `test-strace-openat-openssl` as flaky (Antoine du Hamel) [#61921](https://github.com/nodejs/node/pull/61921)
* \[[`b7117a686f`](https://github.com/nodejs/node/commit/b7117a686f)] - **test**: skip --build-sea tests on platforms where SEA is flaky (Joyee Cheung) [#61504](https://github.com/nodejs/node/pull/61504)
* \[[`e6fb80966f`](https://github.com/nodejs/node/commit/e6fb80966f)] - **test**: fix flaky debugger test (Ryuhei Shima) [#58324](https://github.com/nodejs/node/pull/58324)
* \[[`ab7b742abb`](https://github.com/nodejs/node/commit/ab7b742abb)] - **test**: ensure removeListener event fires for once() listeners (sangwook) [#60137](https://github.com/nodejs/node/pull/60137)
* \[[`16c69f568b`](https://github.com/nodejs/node/commit/16c69f568b)] - **test**: delay writing the files only on macOS (Luigi Pinca) [#61532](https://github.com/nodejs/node/pull/61532)
...
* \[[`ec4b722cb8`](https://github.com/nodejs/node/commit/ec4b722cb8)] - **test**: remove unneccessary repl magic\_mode tests (Dario Piotrowicz) [#61053](https://github.com/nodejs/node/pull/61053)
...
* \[[`0e5ea3b795`](https://github.com/nodejs/node/commit/0e5ea3b795)] - **test**: fix small compile warning in test\_network\_requests\_buffer.cc (xiaocainiao633) [#60281](https://github.com/nodejs/node/pull/60281)
...
* \[[`6fa3b36754`](https://github.com/nodejs/node/commit/6fa3b36754)] - **tools**: switch to ARM runners on GHA jobs (Antoine du Hamel) [#61903](https://github.com/nodejs/node/pull/61903)
* \[[`03c63945d6`](https://github.com/nodejs/node/commit/03c63945d6)] - **tools**: avoid building twice in coverage jobs (Antoine du Hamel) [#61899](https://github.com/nodejs/node/pull/61899)
* \[[`2a264a3605`](https://github.com/nodejs/node/commit/2a264a3605)] - **tools**: use ubuntu-slim runner in GHA (Antoine du Hamel) [#61759](https://github.com/nodejs/node/pull/61759)
* \[[`befceb6451`](https://github.com/nodejs/node/commit/befceb6451)] - **tools**: use ubuntu-slim runner in GHA (Antoine du Hamel) [#61734](https://github.com/nodejs/node/pull/61734)
* \[[`f14c71acc3`](https://github.com/nodejs/node/commit/f14c71acc3)] - **tools**: use ubuntu-latest runner in `notify-on-push` workflow (Antoine du Hamel) [#61742](https://github.com/nodejs/node/pull/61742)
* \[[`3ba6864960`](https://github.com/nodejs/node/commit/3ba6864960)] - **tools**: use ubuntu-slim runner in meta GitHub Actions (Tierney Cyren) [#61663](https://github.com/nodejs/node/pull/61663)
* \[[`50d62a49ac`](https://github.com/nodejs/node/commit/50d62a49ac)] - **tools**: update gyp-next to 0.21.1 (Node.js GitHub Bot) [#61528](https://github.com/nodejs/node/pull/61528)
* \[[`26e4f5a5af`](https://github.com/nodejs/node/commit/26e4f5a5af)] - **tools**: fix vcbuild lint-js-build (Vladimir Morozov) [#61318](https://github.com/nodejs/node/pull/61318)
...
* \[[`a4fad77b01`](https://github.com/nodejs/node/commit/a4fad77b01)] - **typings**: add typing for string\_decoder (Taejin Kim) [#61368](https://github.com/nodejs/node/pull/61368)
...
* \[[`e485d3e6e5`](https://github.com/nodejs/node/commit/e485d3e6e5)] - **zlib**: validate write\_result array length (Ryuhei Shima) [#61342](https://github.com/nodejs/node/pull/61342)
